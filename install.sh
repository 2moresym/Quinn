...
mkdir -p "$MODEL_DIR" "$BIN_DIR" "$SERVICE_DIR"
...
echo
printf 'Quinn installed. Test the daemon with:\n'
printf '  busctl --user introspect org.quinn.Assistant /org/quinn/Assistant\n'
printf 'Then try:\n'
printf '  busctl --user call org.quinn.Assistant /org/quinn/Assistant org.quinn.Assistant Ask s "open terminal"\n'
